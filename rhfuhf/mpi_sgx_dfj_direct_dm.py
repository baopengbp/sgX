...
'''
semi-grid eXchange with direct DF-J and without differencial density matrix
...
'MKL_NUM_THREADS=4 OMP_NUM_THREADS=4 mpirun -np 7 python mpi_sgx_dfj_direct_dm.py'
'''
...
if __name__ == '__main__':
    ...
    import mpi_sgx_dfj_direct_dm as sgx
